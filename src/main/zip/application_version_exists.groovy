// --------------------------------------------------------------------------------
// Check whether the specified Application Version already exists.
// --------------------------------------------------------------------------------
...
try {
    ...
    if (helper.applicationVersionExists(appName, versionLabel)) {
        helper.log("Version \"${versionLabel}\" in application \"${appName}\" exists")
        exitCode = 0
    } else {
        helper.log("Version \"${versionLabel}\" in application \"${appName}\" does not exist")
        exitCode = 1
    }
